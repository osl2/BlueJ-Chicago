...
/**
 * The interface for an array.
 *
 * @param <T>
 *         the type of objects which can be used as values in an array
 */
public interface IArray<T> extends IDatastructure {
    /**
     * Sets specified value at an index in an array.
     *
     * @param index
     ...
     *
     * @param index
     *         the index for which the value wants to be known
