...
public class PlaySpace extends Pane {
	...
	public void linkControllerToBtns(IMainController mainController) {
		int playspeed = (int) this.playSpeedSlider.getValue();
		this.playAutoButton.setOnAction(e -> mainController.setPlayspeed(playspeed));
		this.playStepButton.setOnAction(e -> mainController.playStep());
	}
