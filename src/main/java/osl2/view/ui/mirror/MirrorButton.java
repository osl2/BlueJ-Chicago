...
public class MirrorButton extends Button {
  ...
  /**
   * The Constructor of the MirrorButton. Here the name and mirrorController field will be set to
   * its values.
   *
   * @param name,
  ...
  /**
   * This method links the MirrorButton to the mirrorController. Every Action on the MirrorButton
   * will be sent to the mirrorController
   */
