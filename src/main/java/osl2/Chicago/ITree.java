...
public interface ITree<T> {
	 ...
	 */
	boolean addChild(VNode<T> child, VNode<T> parent);
	 ...
	 */
	boolean removeLeave(VNode<T> node);
	 ...
	 */
	Collection<VNode<T>> getChilds(VNode<T> parent);
	 ...
	 */
	VNode<T> getParent(VNode<T> child);
	 ...
	 */
	boolean swap(VNode<T> child, VNode<T> parent);
	 ...
	 */
	boolean addTree(VNode<T> parent, ITree<T> child);
	 ...
	 */
	boolean contains(Collection<VNode<T>> nodes);
}
